...
if __name__ == "__main__":
    ...
    sparsities = [0.85]  # Single sparsity for testing
    architectures = [
    ...
    print("Skipping detailed analysis and visualization for test version.")
    
    # Exit early for test version
    exit()
    
# Remaining code commented out for test version
#             
